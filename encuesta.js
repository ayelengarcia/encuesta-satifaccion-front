const PRODUCTOS = [];
const URLproductos = "https://best-heliotrope-sphynx.glitch.me/todo/productos";
const URLlista = "https://best-heliotrope-sphynx.glitch.me/todo";
...
function mostrarProductoRecomendado(productosFiltrados) {
  if (productosFiltrados.length > 0) {
    ...
    resultadoDiv.innerHTML = `
            <h3>${productoRecomendado.titulo}</h3>
            <p>${productoRecomendado.descripción}</p>
            <img src="${productoRecomendado.imagen}" alt="${productoRecomendado.titulo}">
            <p>Marca: ${productoRecomendado.marca}</p>
            <p>EAN: ${productoRecomendado.EAN}</p>
        `;
  } else {
